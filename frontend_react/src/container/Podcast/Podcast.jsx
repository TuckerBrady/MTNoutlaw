  ...
  return (
    <>
      ...
      <div className="app__podcasts">
        <motion.div whileInView={{ opacity: 1 }} className="app__podcast-item">
          <iframe
            className="responsive-iframe"
            src="https://anchor.fm/tucker-al-brady/embed/episodes/Episode-5----Colorado-Sucks--2021-Hunting-Application-Strategy--and-LARPing-eps49v"
            height="200px"
            width="850px"
            frameBorder="0"
            scrolling="no"
      ...
      >
        ...
        >
          <a
            href="https://podcasts.apple.com/us/podcast/mtn-outlaw/id1540813137"
            target="blank"
          >
        ...
        >
          <a
            href="https://open.spotify.com/show/70sqJb5Wt6BfUc8q69lWmJ"
            target="blank"
          >
